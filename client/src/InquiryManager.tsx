...
/** 快捷时间范围：本周/本月/上月/近3个月/本年 → 起止日期（询价日期口径，周一为一周开始） */
type RangeKey = '' | 'week' | 'month' | 'lastMonth' | 'q3' | 'year'
const RANGE_LABEL: Record<RangeKey, string> = { '': '全部时间', week: '本周', month: '本月', lastMonth: '上月', q3: '近 3 个月', year: '本年' }
